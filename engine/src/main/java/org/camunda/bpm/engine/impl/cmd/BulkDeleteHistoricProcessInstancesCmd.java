...
public class BulkDeleteHistoricProcessInstancesCmd implements Command<Void>, Serializable {
  ...
  public Void execute(CommandContext commandContext) {
    ...
    ensureEquals("FinishedProcessInstanceIds",new HistoricProcessInstanceQueryImpl().finished()
            .processInstanceIds(new HashSet<String>(this.processInstanceIds)).count(), processInstanceIds.size());
